...
namespace WebApp.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ContactId,ContactTypeId,ApplicationUserId,CompanyId,WorkerId,IsNewContactNeeded,ContactDate,NewContactDate,NewContactType,Comments")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContactId,ContactTypeId,ApplicationUserId,CompanyId,WorkerId,IsNewContactNeeded,ContactDate,NewContactDate,NewContactType,Comments")] Contact contact)
        {
